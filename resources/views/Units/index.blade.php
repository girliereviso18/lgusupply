        ...
        <div class="col-sm-5">
            <div class="card card-outline card-primary">
                <div class="card-header">
                    <h3 class="card-title"style="color: #8a2be2; font-weight: bold;">Add Units</h3>
                </div>
                <div class="card-body">
                    <form action="{{route('admin.units.store')}}" method="POST">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="unit_name" class="form-control" required="required">
                        </div>
                        <div class="form-group">
                                                 ...
                                                 <tr>
                                                   ...
                                                   <td>{{ $unit->unit_name }}</td>
                                                    <td class="text-center">
                                                        <a class="btn btn-sm btn-success" href="{{ url('/admin/units/edit').'/'.$unit->id}}" ><i class="fa fa-edit"></i> Edit</a>
